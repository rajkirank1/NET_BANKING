...
public class Account {
    ...
    public Account(Long accountId, String accountNumber, String accountType,
                   String accountStatus, BigDecimal availableBalance, Long userId) {
    ...
    public static class Builder {
        ...
        public Account build() {
            return new Account(accountId, accountNumber, accountType, accountStatus, availableBalance, userId);
        }
    }
}
